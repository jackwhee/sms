...
urlpatterns = [
    ...
    url(r'^v1/web_reg/(?P<webopenid>[\da-zA-Z!@#$%^&+*\-_]*)/web_voucher$', views.web_user_voucher,
        name='web_user_voucher'),
    ...
    url(r'^v1/moodle/', include('moodle.urls')),

    # url(r'^c_v_script/', views.c_v_script, name='c_v_script'),

    url(r'^prof_course/(?P<prof_id>[\da-zA-Z!@#$%^&+*\-_]*)$', moodle.views.prof_course, name='prof_course')
